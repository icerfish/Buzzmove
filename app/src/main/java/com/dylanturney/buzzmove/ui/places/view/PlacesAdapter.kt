...
import com.dylanturney.buzzmove.databinding.ItemBlogListBinding
...
class PlacesAdapter(private val places: MutableList<Place>) : RecyclerView.Adapter<PlacesAdapter.PlaceViewHolder>() {
    ...
    inner class PlaceViewHolder(private val binding: ItemBlogListBinding) : RecyclerView.ViewHolder(binding.root) {
